...
from ..models.review import Review as ReviewModel, Comment as CommentModel, Like, ReviewImage
...
async def create_review(
    ...
    reviews = db.query(ReviewModel).filter(ReviewModel.product_id == product.id).all()
